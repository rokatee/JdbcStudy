...
VALUES (EMPSEQ.NEXTVAL, '고연수', '940925-2234567', TO_DATE('2015-05-16', 'YYYY-MM-DD')
        ...
        , 1000000);
--> 한 줄 구성
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_IT, TEL, BUSEO_IT, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '%s', '%s', TO_DATE('%s', 'YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC = '%s'), '%s', (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '%s'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '%s'), %d, %d)
;
...
-- JIKWI_NAME = '부장';
--> 한 줄 구성
SELECT EMP_ID, EMP_NAME, SSN, TO_CHAR(IBSADATE, 'YYYY-MM-DD') AS IBSADATE, CITY_LOC, TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY FROM EMPVIEW WHERE %s = '%s'
;
...
SET EMP_NAME = '민찬우'
  , SSN = '900000-1000000'
  , IBSADATE = TO_DATE('2015-06-15', 'YYYY-MM-DD')
  , CITY_ID = (SELECT CITY_ID
               FROM TBL_CITY
               WHERE CITY_LOC = '서울')
  , TEL = '010-8888-8989'
  , BUSEO_ID = (SELECT BUSEO_ID
                FROM TBL_BUSEO
...
WHERE EMP_ID = 1063;
--> 한 줄 구성
UPDATE TBL_EMP SET EMP_NAME = '%s', SSN = '%s', IBSADATE = TO_DATE('%s', 'YYYY-MM-DD'), CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC = '%s'), TEL = '%s', BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '%s'), JIKWI_ID = (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '%s'), BASICPAY = %d, SUDANG = %d WHERE EMP_ID = %d
;
...
WHERE EMP_ID = 1;
--> 한 줄 구성
DELETE FROM TBL_EMP WHERE EMP_ID = %d
;



INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) 
VALUES (EMPSEQ.NEXTVAL, '김인교', '810809-1444444', '2002-11-11', 1, '010-4151-4444', 1, 9, 900000 , 102000);
